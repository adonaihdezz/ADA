...
int NumThreads;			//Nï¿½mero de threads
int N,*A,num,n,ind=0;
...
int main(int arg, char* argv[])
{
	...
	pthread_t *thread;
//***************************************************************************************************************************
// Verificar parï¿½metros y llenar el arreglo
//***************************************************************************************************************************	
	if (arg<2) 
	{
		printf("Indique el nï¿½mero de threads - \tEjemplo: [user@equipo]$ %s 4\n\n",argv[0]);
		exit(-1);
	}
...
//***************************************************************************************************************************
// Buscar cada nï¿½mero en el arreglo
//***************************************************************************************************************************
	...
	//***************************************************************************************************************************
	// Calcular los tiempos de ejecuciï¿½n
	//***************************************************************************************************************************
...
RETORNO:Retorna el numero mas pequeï¿½o entre los 2.
*/
...
PARAMETRO n: Tamaï¿½o del arreglo.
*/
